...
- [ ] 心理 & 生活任务
	- [ ] 勇敢的决定休息，并投入一次彻底的睡眠
	- [ ] 主动积极完成一次看似不可能的高挑战任务：在明天12：45之前完成所有的学习任务
	- [ ] 在压力大时成功完成一次心理调适，将对压力的不适转换为对挑战的兴奋
	- [ ] 独立承担一次高挑战任务和高挑战任务带来的心理压力，不通过向他人诉苦解决
	- [ ] 在有挑战时保证睡眠时长和质量
	- [ ] 自信的去参加一次面试，勇敢的向老师陈述自己的情况
- [ ] 时间挑战
	- [ ] 9点20之前完成洗漱，并且直接关灯上床睡觉，盖被子之后不再去想现实生活中的任何事情，做到彻底的断舍离
	- [ ] 24号早上5点起床，9点之前完成数据结构和算法方面的学习任务（4小时）
	- [ ] 12点45之前完成计算机体系结构、操作系统的相关学习任务（4小时）
	- [ ] 16：30 之前完成考试内容
