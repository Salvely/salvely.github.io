...
- [ ] 推动研究生和导师的地位平等，让学生自主选择导师，让没有水平、瞧不起人、压迫学生、学历歧视的导师彻底滚蛋；
- [ ] 推动父母和孩子关系平等，促使法律对父母行为的监管，以及社会对恶劣原生家庭中的孩子的养育和关怀，对向孩子施加控制和精神霸凌的父母判刑；
- [ ] 提高人的整体素质水平、让没有德行的烂人彻底从社会上滚蛋；
- [ ] 实现阶级平等，不允许天龙人剥夺普通人的善意和钱，滥用阶级特权；
...
- [ ] **计算机学习路径全部完成**，学习各门课程，大量尝试各种内容，发掘自己的爱好所在（不要通过想象力去脑补，要通过真实的体验去感受），掌握计算机技术。并且通过研读论文，准备进行进一步的科学研究
	- 目标：成为顶尖的计算机科学家，超越一切人的计算机水平，成为虐杀级别的大神；
...
- [ ] **英语能力终极强化**，要能做到和外国人交流无障碍，阅读、写作、听力无障碍，对国外文化有深入了解
	- 目标：成为英语水平顶尖的人，薄纱英语专业学生，讲一口让美国人都惊叹的流利英语；
	- [ ] 词汇量终极进化
		- [ ] 知乎搜集词汇量增大的方法 🆔 3spscf
...
- [ ] **数学学习完成**，像法国人那样掌握深厚的数学功底，能够做到对数学本身、以及计算机科学中的数学有游刃有余的使用能力，并且能够利用数学进行新的科研工作，对理论计算机、算法、数理逻辑，尤其是组合数学进行研究
	- 目标：数学水平达到顶尖，成为数学能力最强的人，锻炼自己的智力和脑回路，再也不让人诟病自己的数学水平；
	- [ ] 基础数学四大课程学习完成
		- [ ] 彻底根除数分顽疾
		- [ ] 高代（线代）
		- [ ] 常微分方程
...
- [ ] **阅读海量系统，AI，理论计算机相关论文，复现大量论文**，广泛学习科研成果，争取在硕士入学前就发表自己的系统顶会论文
	- 目标：在系统软件方向超越陈海波和PDos Lab的老师，成为系统软件方向最顶尖的人，让系统软件方向力压AI方向，再次伟大；
	...
	- [ ] 精读10篇SOSP/OSDI论文（复现至少2篇，代码放GitHub）
	- [ ] 每周更新技术博客（论文解读/项目总结）
	- [ ] 复现时候的疑点可以邮件联系老师
...
- [ ] **社科书籍海量阅读**，并做阅读记录，要通晓历史和政治，深刻掌握中国历史和国情，以及人的生活
	- 目标：成为人文社科巨佬，对社会和历史有深刻的洞察，能练出毛主席那样预见未来的能力；
	- [ ] 历史书籍阅读学习完成
		- [ ] 近现代史书籍搜集
		- [ ] 近现代史书籍阅读并总结
		- [ ] 毛选下载
...
- [ ] **减肥 20 斤**，解锁俯卧撑、引体向上和八块腹肌，健身，增长肌肉，成为大美女，彻底从被人歧视外貌的境遇中走出来，在参加工作前练出一身肌肉，美白护肤，学会化妆，购买一身新衣服，让外貌无限接近游戏建模，为以后找对象做准备
	- 目标：成为顶级素颜美女，超越刘亦菲，让所有女生跟我相比都相形见绌；
	- [ ] 基础生物学学习；
	- [ ] 运动解剖学学习；
	- [ ] 人体解剖学学习；
	- [ ] 运动生理学学习；
...
- [ ] 入选字节筋斗云计划
- [ ] 玩《黑暗之魂1》，直到达成所有成就；
	- 我的目的：保护太阳骑士索拉尔、洋葱骑士和防火女不死，并且最后同我一起击败格温王，点燃初火，带来永恒的太阳、光明和希望；
	- [ ] 初始阶段
		- [x] 选【战士】 ✅ 2025-06-11
			- 我选了无用之人
		- [x] **初始礼物**：选「万能钥匙」（可跳过病村下层） ✅ 2025-06-11
			- 我选了【女神的祝福】，用来保护洋葱骑士
		- [ ] |**哈维尔戒指**|夹缝森林塔楼|增加负重上限|
	- [ ] 不死院 → 传火祭祀场
		- **目标**：击败恶魔，拿到「 Estus 瓶」
		- [x] 从高处跳下处决BOSS ✅ 2025-06-11
		- [x] 捡起「盾牌」和「剑」 ✅ 2025-06-11
		- [ ] 到达传火祭祀场，先去「墓地」捡「双手巨剑」（但别深入，会被骷髅虐）
		- [ ] 去「不死镇下层」拿「飞龙剑」
		- [ ] 防火女不死，祭祀场篝火可升级，未变成活尸
			- [ ] 核心：不要攻击或杀死防火女，给她【人性】治愈黑暗印记；
	- [ ] 不死镇（主线）→ 底层 → 病村（带够苔藓球）→ 黑森林（刷魂宝地）
		- [ ] 不死镇断红龙尾巴，获得飞龙剑
		- **推荐刷魂点**
		    - [ ] 前期：黑森林（引悬崖怪自杀）
			    - [ ] |**草纹盾**|黑森林刷树妖|精力恢复加速|
		    ...
		    - [ ] 夹缝森林（拿草纹盾）
		    - [ ] 小隆德（后期地图）
		- _⚠️ 千万别去墓地/小隆德（那是后期地图）_
	- [ ] 拯救太阳骑士，最终战前可召唤，对话提及【找到太阳】
		- 核心：提前击杀所有太阳虫
		- 如果你在太阳虫区域看到他的召唤符，说明已失败；
		- 提前装备「太阳长男戒指」可增加他的生存意志（玄学但有效）
		- **病村前**：
			- **目标**：确保他保持理智
		    - [ ] 在「城外不死教区」与他对话至重复
			- [ ] 获得白标记蜡石（用于被他召唤）
		- **恶魔遗迹**：
			- **目标**：避免他被太阳虫腐蚀
		    ❌ **绝对不能**在「混沌废都伊扎里斯」的岩浆区域与他对话（触发发疯事件）
			- [ ] **不要走岩浆区**（直接跳捷径）
			- [ ] **优先击杀所有「太阳虫」**（戴着头盔的怪）
			- [ ] **返回太阳祭坛**，他会说"我终于找到我的太阳了"
		- **替代路线**：
		    - [ ] 击败混沌温床后，直接跳进「恶魔遗迹」的捷径（无需经过岩浆区）
		    - [ ] 快速击杀「太阳虫」头盔怪（此怪会腐蚀索拉尔）
		    - [ ] 返回太阳祭坛与他对话，他会说："_我终于找到我的太阳了..._"
	- [ ] 拯救洋葱骑士，通关后出现在传火祭祀场，赠送【洋葱泪石】
		- 核心：给他女神祝福，并且杀死所有恶魔，防止他累死或自杀；让他自己睡醒，不要提前开启古城捷径；
		- 赛恩古城阶段
			- **目标**：确保洋葱骑士存活
			- [ ] 在巨人扔火桶前与他对话（触发他睡觉剧情）
			    - [ ] **在巨人扔火桶前**找到他（坐在机关旁）
		...
		- 亚诺尔隆德阶段
			- **目标**：确保他提到女儿
			- [ ] 在银色弓箭手区域与他对话（他会说女儿在等他）
			    - [ ] 在旋转楼梯附近找到他
			    - [ ] **对话至重复**（他会说"女儿在等我"）
			    - [ ] **提前击杀所有银骑士**（防止他战死）
		- 混沌废都终章
			- **目标**：避免他跳进岩浆自杀
			- [ ] 在岩浆房见到他时，**立刻装备「橘色戒指」**（增加火焰抗性）
			- [ ] 对话选择："_一起喝杯酒_" → 给他3个「女神祝福」（解除中毒状态）
			- [ ] 快速击杀周围的混沌恶魔（防止他参战）
			- [ ] **最终在传火祭祀场外见到他和女儿团聚**
	- [ ] 玩DLC：**深渊的阿托利亚斯**
		- [ ] **推荐等级**：70+（至少30点耐力）
		- [ ] **前置条件**
			- 击败「夹缝森林的七头蛇」
			- 击败「金色结晶巨人」（救出幽暗公主）
			- 获得「破碎的项链」（在公爵书库存档点附近捡取）
		- [ ] **进入步骤**
			- [ ] **前往「乌拉席尔」**
				- [ ] 在夹缝森林湖底（原七头蛇位置）出现新传送门
				- [ ] 触碰黑色漩涡进入DLC
	- [ ] 回到传火祭祀场
		- 若洋葱父女在旁边喝酒就是成功， 如果索拉尔的装备遗落在太阳祭坛就是失败
		- 防火女会说【感谢您让火焰有了新的意义】
	- [ ] 去【王城】击败格温王，选择【传承初始之火】并触发特殊动画
		- 核心：不要选【黑暗之王】
		- [ ] 装备
			- **黑骑士剑**（高伤害）
			- **草纹盾**（精力恢复）
...
- [ ] 完成奖励
	...
	- [ ] 游泳装备购买
	- [ ] 购买各种嵌入式设备来玩，包括FPGA
	- [ ] 购买各种电子元器件来焊接，自己DIY一些嵌入式设备
	- [ ] 实现居住地自由：上海/杭州/国外
	- [ ] 实现旅游自由：华山，泰山，黄山，北京
	- [ ] 实现护肤品自由：洗发露，护发素，发膜，护肤品，面膜，光子嫩肤
	- [ ] 实现运动自由：游泳，健身，羽毛球，乒乓球，可以减肥健身成为大美女了；
	- [ ] 实现新的社交圈：打球的好朋友，技术的好朋友，吃饭的好朋友，旅游的好朋友，音乐的好朋友，一群群新的好朋友
	- [ ] 实现游戏自由：黑神话悟空，GTA5，城市天际线，寂静岭2，生化危机7等等；
	- [ ] 实现穿搭自由：可以自由搭配衣服了，可以穿自己喜欢的衣服，搭配漂亮的小裙子了；
	- [ ] 实现音乐自由：小提琴、木吉他、电吉他、口琴，可以自由享受音乐了，还会有好多交流音乐的伙伴！
...
- [ ] 学习摄影
	...
	- [ ] 知乎搜索摄影学习过程及学习资料
	- [ ] 开始系统学习摄影
- [ ] 继续修炼下厨技能，开发出各种好吃的菜品，成为厨神；
- [ ] 学习模型制作，自己做出亚尔特留斯、洋葱骑士等的模型；
- [ ] 先努力冲到这一步，后面的事情不要多想，也不要想太多，现阶段找到人生的热情和热爱是最重要的事，其他的后面再说；
- [ ] 去找学长

## 系统科研阶段

- [ ] 做系统方向科研，积累**3篇**系统方向顶级会议论文
...
- [ ] **组织几个人爬一次华山** 📅 2025-10-1
- [ ] 申请到MIT PDos Lab的phD 📅 2026-9-1
- [ ] 先把自己的经验全部放在博客中，然后再整理出一些问题解决手册和实用生活自救指南，帮助困境中的他人
- [ ] 从2026年9月申请，到2027年9月入学，一年间再发表3篇系统顶级会议论文； 📅 2027-9-1
