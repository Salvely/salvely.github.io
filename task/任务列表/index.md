...
- [ ] 努力进行系统方向科研，必须成为系统顶级会议论文大满贯（且科研成果质量过硬），然后**申请MIT PDos 实验室的 CS phD**；
...
- [x] 购买代理 ✅ 2025-01-05
- [ ] **计算机学习路径全部完成**，学习各门课程，大量尝试各种内容，发掘自己的爱好所在（不要通过想象力去脑补，要通过真实的体验去感受），掌握计算机技术。并且通过研读论文，准备进行进一步的科学研
